...
export const Contact = () => {
  return (
    ...
    <div className="contact">
      ...
      <p className="heading-desc">I’m currently looking for new opportunities to learn and develop. My inbox is always open, Whether you have a question or just want to say hi, I’ll try my best to get back to you!</p>
      <div className="contact-links">
        <div className="normal-b"><a
        ...
        <div className="normal-b"><a href={Resume} rel="noreferrer"
          target="_blank"
          className="dbutton">Resume</a></div>
