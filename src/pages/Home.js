    ...
    <div className="main">
      ...
      <p className="greeting">Hello, I am Akash👋</p>
        <div className="top-block">
          <p>
            I am a student at GITAM Deemed to be University, India. An aspiring
            Computer Science Engineer currently Working towards Web and mobile
            Application Development.
          </p>
          <img src={myImg} alt="Myprofile-img" width={500} className="profile-img"/>
        </div>
        <div className="links">
